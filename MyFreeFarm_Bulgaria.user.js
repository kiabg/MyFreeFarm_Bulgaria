...
// @include     http://www.veselaferma.com/*
// @version     1.0.0
// @grant       GM_log
// ==/UserScript==
// Translation by kimcho
...
try{
	...
	texte["msgMarketsaleContent"]="(.*) bought (\\d+)x (.*?) for<br> (.*?) pD from you\\."; // The text where the information is stated. The information has to be replaced by "(.*?)".
	texte["msgContractsaleContent"]="(.*) has signed a contract of yours!<br><br> The following products have been sold:<br>(.*?)<br> The amount of (.*?) pD has been credited to your account\\."; // The text where the general information is stated. The information has to be replaced by "(.*?)".
	...
	texte["confirmChangelogVersion"]="You have installed a new version of the Adviser script.<br>The version %1% contains the following changes:";
	...
	texte["farmzone"]="Building place %1% of %2%. ферма";
	texte["feed"]="Feed";
	texte["filter"]="Filter";
	texte["filterForX"]="Filter for %1%";
	texte["finished"]="Готово";
	...
	texte["fl1"]="Поляна за Цветя";
	texte["fl2"]="Цветарска Работилница";
	texte["fl3"]="Monster fruit culture";
	texte["fl6"]="Speed eating";
	...
	texte["given"]="Given";
	texte["goToDonkey"]="Go to donkey Luke";
	...
	texte["login"]="Login";
	texte["logDonkey"]="Donkey Luke Log";
	...
	texte["price"]="Price";
	texte["prices"]="Prices";
	texte["product"]="Продукти";
	texte["productOverview"]="Общ преглед на продукта";
	...
	texte["shadowboxitem"]="Shadowbox item";	
	texte["shortHours"]="h";
	texte["shortOClock"]="h";
	texte["shouldReload"]="You should reload the page.";
	texte["showAll"]="Покажи all";
	texte["showChangelog"]="Покажи changelog";
	texte["showLog"]="Покажи log";
	texte["showMissingProducts"]="Покажи product shortage";
	texte["showPasswords"]="покажи passwords";
	texte["sinceX"]="since %1%";
	texte["single"]="Single";
	texte["start"]="Start";
	texte["stat_days1"]="1 ден";
	texte["stat_days3"]="3 дни";
	texte["stat_days5"]="5 дни";
	texte["stat_days7"]="7 дни";
	texte["stat_gamefield"]="Покажи game";
	texte["stat_stats"]="Покажи statistics";
	...
	// category
	texte["category_c"]=texte["Кредити"];
	texte["category_v"]="Растения";
	texte["category_e"]="Допълнителни продукти";
	...
	texte["category_fw1"]="Напитки";
	texte["category_fw2"]="Храна";
	texte["category_fw3"]="Торти";
	texte["category_fw4"]="not yet available";
	texte["category_fl"]="Flowers";
	texte["category_fla"]="Arrangements";
	...
	texte["category_r0"]="Рецепти product";
	texte["category_r1"]="Рецепти increade yield";
	texte["category_r2"]="Рецепти increade points";
	texte["category_p0"]="Сила Produkt";
	texte["category_p1"]="Сила increade yield";
	texte["category_p2"]="Сила increade points";
	// settings
	...
	texte["settings_valQuicklinks"]=["Покажи market quicklinks","Покажи Quicklinks at Market place"];
	...
	texte["automat_automatPlanting"] = "Машина за сеене";
	...
	texte["automat_settings_botErrorBehaviour"] = "Behaviour of Automaton in case of errors";
	texte["automat_settings_pageReload"] = "Reload of page";
	texte["automat_settings_botRestart"] = "Restart bot";
	...
	texte["automat_confirmChangelogVersion"]="You have installed a new version of the Automaton script.<br>The version %1% contains the following changes:";
	...
	texte["automat_settings_autoPlant"] = "Shall the planting machine be displayed?";
	texte["automat_settings_autoWater"] = "Shall the fields be watered?";
	texte["automat_settings_autoFeed"] = "Shall the feeding machine be displayed?";
	texte["automat_settings_botUse"] = "Use bot";
	texte["automat_settings_disableCropFields"]="Block the cropping of sleeping fields.";
	texte["automat_settings_pauseShortMin"] = "Minimal clicking delay of the automaton";
	texte["automat_settings_pauseShortMax"] = "Maximal clicking delay of the automaton";
	texte["automat_settings_pauseMin"] = "Minimal waiting delay of the automaton";
	texte["automat_settings_pauseMax"] = "Maximal waiting delay of the automaton";
	texte["automat_settings_maxDurationBotRun"] = "Maximal running time of the automaton";
	texte["automat_settings_maxDurationBotStep"] = "Maximal running time for a step of the automaton";
	texte["automat_setToDefault"] = "Set to default";
	texte["automat_settings_seedWaitForCrop"] = "Wait planting if next cropping time is less than";
	texte["automat_emergencyPlants"] = "Emergency Plants. They are taken first if the needed plant is not available or fitting.";
	texte["automat_settings_useQueueList"] = "Use queue for the fields.";
	texte["automat_set12a"] = "Delete \n all zone queue\n data";
	texte["automat_set12b"] = "Delete Completed.";
	texte["automat_settings_showQueueTime"] = "Покажи calculated product ready time in the queue.";
	texte["automat_set18a"] = "Delete all mill queue data";
	texte["automat_set18b"] = "Delete Completed";
	texte["automat_settings_powerUpActivate"] = "Activate powerups for products";
	texte["automat_settings_lotteryActivate"] = "Activate the daily lottery automatically";
	texte["automat_settings_lotteryDailyLot"] = "Choose to keep the daily lot";
	texte["automat_settings_questActivate"] = "Activate the Quest automatically to quest:";
	texte["automat_settings_questSolving"] = "Solve the Quest automatically to quest:";
	texte["automat_settings_farmiReject"] = "Auto reject farmi below:";
	texte["automat_settings_farmiAccept"] = "Auto accept farmi above:";
	texte["automat_settings_farmiAcceptBelowMinValue"] = "Accept a farmi with an product item that is below the minimal product amount in the rack.";
	texte["automat_settings_farmiRemoveMissing"] = "Remove a farmi with missing products and the lowest yield. Threshold:";
	...
	texte["automat_buttonTimeLine"] = "Покажи field timelines";
	texte["automat_buttonOverview"] = "Покажи overview of automatons";
	...
	texte["automat_MillStopX"] = "After %FLDFROM% Рецепти the automatic bakeing process will be stopped.";
	try{
	...
	texte["automat_MillRecipesBought"] = "Total Рецепти bought: ";
	texte["automat_MillRecipesUsed"] = "Total Рецепти used: ";
	texte["automat_MillRecipesBake"] = "Max Рецепти to bake: ";
	//title
	texte["automat_title_on_general"] = "Покажи general queue only<br>+Ctrl: Покажи general queue";
	texte["automat_title_off_general"] = "Покажи general queue only<br>+Ctrl: Hide general queue";
	texte["automat_title_on_farm1"] = "Покажи first farm only<br>+Ctrl: Покажи first farm";
	texte["automat_title_off_farm1"] = "Покажи first farm only<br>+Ctrl: Hide first farm";
	texte["automat_title_on_farm2"] = "Покажи second farm only<br>+Ctrl: Покажи second farm";
	texte["automat_title_off_farm2"] = "Покажи second farm only<br>+Ctrl: Hide second farm";
	texte["automat_title_on_farm3"] = "Покажи third farm only<br>+Ctrl: Покажи third farm";
	texte["automat_title_off_farm3"] = "Покажи third farm only<br>+Ctrl: Hide third farm";
	texte["automat_title_on_farm4"] = "Покажи fourth farm only<br>+Ctrl: Покажи fourth farm";
	texte["automat_title_off_farm4"] = "Покажи fourth farm only<br>+Ctrl: Hide fourth farm";
	texte["automat_title_on_farmersmarket"] = "Покажи farmersmarket only<br>+Ctrl: Покажи farmersmarket";
	texte["automat_title_off_farmersmarket"] = "Покажи farmersmarket only<br>+Ctrl: Hide farmersmarket";
	texte["automat_title_on_city"] = "Покажи city only<br>+Ctrl: Покажи city";
	texte["automat_title_off_city"] = "Покажи city only<br>+Ctrl: Hide city";
	texte["automat_title_on_forestry"] = "Покажи forestry only<br>+Ctrl: Покажи forestry";
	texte["automat_title_off_forestry"] = "Покажи forestry only<br>+Ctrl: Hide forestry";
	texte["automat_title_on_foodworld"] = "Покажи picnic area only<br>+Ctrl: Покажи picnic area";
	texte["automat_title_off_foodworld"] = "Покажи picnic area only<br>+Ctrl: Hide picnic area";
	texte["automat_title_on_type1"] = "Покажи fields only<br>+Ctrl: Покажи fields";
	texte["automat_title_off_type1"] = "Покажи fields only<br>+Ctrl: Hide fields";
	texte["automat_title_on_type2"] = "Покажи stables only<br>+Ctrl: Покажи stables";
	texte["automat_title_off_type2"] = "Покажи stables only<br>+Ctrl: Hide stables";
	texte["automat_title_on_type3"] = "Покажи factories only<br>+Ctrl: Покажи factories";
	texte["automat_title_off_type3"] = "Покажи factories only<br>+Ctrl: Hide factories";
	texte["automat_title_on_all"] = "Покажи all farm queues";
